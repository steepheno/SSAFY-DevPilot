...
from AI.fastapi.app.LLM.service.session_manger import get_or_create_session_id
...
def generate_text(request: Request, request_data: QueryRequest):
    session_id, is_new_session = get_or_create_session_id(request)
    response = generate_chat_response(session_id, request_data.question)
