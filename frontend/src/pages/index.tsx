...
export { default as NewBuildPage } from './newBuildPage';
...
export { default as LoginPage } from './BuildInfoPage.tsx';
export { default as InitialPage } from './BuildInfoPage.tsx';
